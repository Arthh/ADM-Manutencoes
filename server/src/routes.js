...
routes.delete('/delete-setor/:id', SetorController.delete);
...
routes.delete('/delete-maquinas/:id', MaquinasController.delete);
...
routes.delete('/delete-pservico/:id', PServicosController.delete);
...
routes.delete('/delete-ordman/:id', OrdemManutencao.delete);
